...
public class FragmentLoan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabResult.setOnClickListener(view -> {
            ...
            if (Objects.requireNonNull(etLoanAmount.getEditText()).getText().toString().isEmpty() || Objects.requireNonNull(etLoanTerm.getEditText()).getText().toString().isEmpty() || Objects.requireNonNull(etInterestRate.getEditText()).getText().toString().isEmpty())
                ...
                Objects.requireNonNull(etMonthlyPay.getEditText()).setText(String.format(Locale.FRANCE, "%.2f", calculateLoanMonthlyPay(Integer.valueOf(etLoanAmount.getEditText().getText().toString()), Integer.valueOf(etLoanTerm.getEditText().getText().toString()), Double.valueOf(etInterestRate.getEditText().getText().toString()))));
                Objects.requireNonNull(etTotalInterest.getEditText()).setText(String.format(Locale.FRANCE, "%.2f", calculateLoanTotalInterest(Integer.valueOf(etLoanAmount.getEditText().getText().toString()), Integer.valueOf(etLoanTerm.getEditText().getText().toString()), Double.valueOf(etInterestRate.getEditText().getText().toString()))));
            }
        });
        return v;
    }
